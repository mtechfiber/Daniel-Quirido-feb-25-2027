...
<div class="container">
  ...
  <div class="footer">© 2026 DC-INTERNET AND ELOADING STATION | Secure Access Portal</div>
</div>
...
<div id="qrModal" class="modal" onclick="closeAll()">
  <div class="modal-content" onclick="event.stopPropagation()">
    ...
    <img id="qrImage">
    <div>DANIEL S. QUIRIDO</div>
    <div class="number-box" id="payNumber">0970-358-4500</div>
    ...
    <div class="payment-note">
      ...
      <br><br>Facebook: Daniel Quirido
      <br>Phone: 0970-692-1925
    </div>
  </div>
</div>
...
<div id="contactModal" class="modal" onclick="closeAll()">
  <div class="modal-content" onclick="event.stopPropagation()">
    ...
    <a href="tel:+639706921925" class="option-btn call-btn">
      📞 Call Now
    </a>
